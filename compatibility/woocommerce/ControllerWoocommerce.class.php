 ...
 */
class ControllerWoocommerce extends BaseController
{
    /**
     * @var string
     */
    protected string $name = 'WooCommerce Login & Registration';
    ...
    {
        return apply_filters('f12_cf7_captcha_is_installed_woocommerce', $this->is_installed() && (int)$this->Controller->get_settings('protection_woocommerce_enable', 'global') === 1);
    }
    ...
    {
	    $this->name = __('WooCommerce Login & Registration', 'captcha-for-contact-form-7');

        add_action('woocommerce_login_form', array($this, 'wp_add_spam_protection'));
        add_filter('woocommerce_process_login_errors', array($this, 'wp_is_spam'), 10, 3);
