...
class ControllerWoocommerceLogin extends BaseController
{
    ...
    {
        return apply_filters('f12_cf7_captcha_is_installed_woocommerce_login', $this->is_installed() && (int)$this->Controller->get_settings('protection_woocommerce_login_enable', 'global') === 1);
    }
    ...
    {
	    $this->name = __('WooCommerce Login', 'captcha-for-contact-form-7');
